                    ...
                    <form action="<?= base_url('produk/store') ?>" method="post">
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="nama_produk" class="form-control <?= form_error('nama_produk') ? 'is-invalid' : '' ?>" placeholder="Nama Produk">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="harga" class="form-control number <?= form_error('harga') ? 'is-invalid' : '' ?>" placeholder="Harga">
                                <div class="invalid-feedback">
                                    <?= form_error('harga') ?>
                                </div>
                            </div>
